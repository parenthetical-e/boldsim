...
from boldsim.expclass.rwfit import RWAR1a08


class RunRWAR1a08(Run):
    ...
    def __init__(self):
        ...
        # should go here.
        self.BaseClass = functools.partial(RWAR1a08, behave="learn")  
...
if __name__ == "__main__":
    ...
    results_name = "rw_{0}_learn_ar1a08".format(sim.nrun)
