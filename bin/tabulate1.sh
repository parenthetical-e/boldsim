...
echo "rw_5000_learn_4alpha.hdf5 t 2.6810" >> tabulate1.log
python $BASEDIR/boldsim/bin/tabulate_above.py $DATADIR/rw_5000_learn_4alpha.hdf5 t 2.6810 rw_5000_learn_4alpha
echo "rw_5000_learn_4alpha.hdf5 t 4.317" >> tabulate1.log
python $BASEDIR/boldsim/bin/tabulate_above.py $DATADIR/rw_5000_learn_4alpha.hdf5 t 4.317 rw_5000_learn_4alpha


# ----
# The noise analyses
# Skipping these.  Use tabulate3.sh instead
