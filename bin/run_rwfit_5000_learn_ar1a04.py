...
from boldsim.expclass.rwfit import RWAR1a04


class RunRWAR1a04(Run):
    ...
    def __init__(self):
        ...
        # should go here.
        self.BaseClass = functools.partial(RWAR1a04, behave="learn")  
...
if __name__ == "__main__":
    ...
    results_name = "rw_{0}_learn_ar1a04".format(sim.nrun)
